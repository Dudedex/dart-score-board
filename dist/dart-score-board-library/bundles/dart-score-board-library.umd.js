    ...
    var DartBoardComponent = /** @class */ (function () {
        ...
        DartBoardComponent.decorators = [
            { type: i0.Component, args: [{
                        ...
                        styles: [".board-container{width:100%;max-width:1000px;margin:0 auto;padding:.5rem}.right{float:right}.revert-label{margin-right:1rem;font-size:2rem;margin-left:.5rem}"]
                    }] }
        ];
        /** @nocollapse */
