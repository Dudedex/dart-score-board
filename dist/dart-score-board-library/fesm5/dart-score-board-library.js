...
var DartBoardComponent = /** @class */ (function () {
    ...
    function (type, field, event) {
        var _this = this;
        this.clickedId = ((/** @type {?} */ (event.target))).id;
        setTimeout((/**
         * @return {?}
         */
        function () {
            _this.clickedId = undefined;
        }), 750);
        /** @type {?} */
     ...
     * @return {?}
     */
    DartBoardComponent.prototype.getFillColor = /**
     * @param {?} elementId
     * @param {?} defaultColor
     * @return {?}
     */
    function (elementId, defaultColor) {
