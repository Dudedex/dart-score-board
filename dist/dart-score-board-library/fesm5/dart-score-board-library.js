...
var DartBoardComponent = /** @class */ (function () {
    ...
    DartBoardComponent.decorators = [
        { type: Component, args: [{
                    ...
                    styles: [".board-container{width:100%;max-width:1000px;margin:0 auto}.right{float:right}.revert-label{margin-right:1rem;font-size:2rem;margin-left:.5rem}.panel{padding:0;overflow-x:hidden;overflow-y:hidden}"]
                }] }
    ];
    /** @nocollapse */
